...
var show_container = document.getElementById("show-container");
var input_show = document.getElementById("input-show");
var submit_button = document.getElementById("submit-data");
...
function getTVshow() {
  return _getTVshow.apply(this, arguments);
}
function _getTVshow() {
  _getTVshow = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var dataPromise, dataJSON;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return fetch(url + input_show.value);
        case 2:
        ...
        case 5:
          ...
          dataJSON.forEach(function (data) {
            var show_data_element = document.createElement("div");
